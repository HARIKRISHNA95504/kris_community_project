    ...
    return(
        <main>
            <div className="font-sans bg-sky-100 min-h-screen">
                ...
                <div className="bg-white md:ml-20 md:mr-20 md:mt-5 md:pb-8">
                    ...
                    <div className="md:grid md:grid-col-1 md:ml-20 md:mr-20 md:mt-1 text-start">
                        <article className="border md:w-7/12 md:ml-72  rounded bg-sky-100">
                    ...
                    <div className="text-center pt-2">
                        <butto className="border border-green-600 bg-green-600 text-lg rounded text-white text-center md:px-24  md:py-2 ">Approve</butto>
                        <button className=" border border-red-600 text-lg rounded text-red-600 text-center md:ml-5 md:px-20 p-1">Decline</button>
                    </div>
                </div>
